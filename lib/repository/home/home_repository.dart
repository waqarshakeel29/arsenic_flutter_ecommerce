...
abstract class HomeRepository {
  Future<Either<ItemsFetchError, List<StoreItem>>> getHomeProducts(String uid);

  Future<Either<ItemsFetchError, List<StoreItem>>>
      getSelectedFilteredHomeProducts(String filterString);
  Future<Either<ItemsFetchError, List<StoreItem>>>
      getCatagoriesFilteredHomeProducts(List<String> filterList);
}
